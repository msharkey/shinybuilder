...
This book supplments my presentation at the Omaha R User Group on Thursday, April 4, 2019.


## Intended Audience {-}

If you develop Shiny Applications and your backend is a relational database then this book is for you.  The demos and code snippets are written in T-SQL, Microsoft SQL Server dialext of SQL, but the core concepts are applicable accross all RDBMS systems.
...
The reader should have some experiance writing R code or programming.  Any knowledge of SQL and relational databases will help but is not required.
