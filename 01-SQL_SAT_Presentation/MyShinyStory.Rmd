...
library(odbc)
library(DBI)
sqlcon <- dbConnect(drv = odbc(),  Driver = 'Sql Server',Server = '.',Database = 'Test' ,Trusted_Connection='yes')
```
...
The app seems a little slugish on my machine.  If performance isn't acc
