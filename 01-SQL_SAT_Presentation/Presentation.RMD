...
![](./Images/mark-de-rooij-k59C8rWwPAo-unsplash.jpg)

---

.pull-left[
![](./Images/76-debugging.png)

]

.pull-right[

![](./Images/127-end-of-the-line.png)
...
<iframe src="https://giphy.com/embed/WhFfFPCEDXpBe" width="480" height="360" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/error-WhFfFPCEDXpBe">via GIPHY</a></p>
...
## Handling Deadlocks Client Side
...
- Recorded an typical user session

--

- Ran load test with shinycannon
...
- Removed OPTION recompile hint from query
