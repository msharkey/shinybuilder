...
author: "R can do more than just statistics and data viz!  In this session I will demonstrate the packages and techniques for building reactive web dashboards with R and SQL Server."
date: "`r Sys.Date()`"
